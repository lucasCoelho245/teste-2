...
using Pay.Recorrencia.Gestao.Inclusao.Autorizacao.Recorrencia.Consumer.Consumer.DTO;
using Pay.Recorrencia.Gestao.Inclusao.Autorizacao.Recorrencia.Consumer.Consumer.Validator;
using System.Text;
using System.Text.Json;

namespace Pay.Recorrencia.Gestao.Inclusao.Autorizacao.Recorrencia.Consumer.Consumer
{
    public class ConsumerCustomTopic : IConsumerOperation
    {
        ...
        public ConsumerCustomTopic(
            ILogger<ConsumerCustomTopic> logger, 
        ...
        public async Task ConsumeAsync(string topic, int partition, string message, Headers headers, string topicWithEnvironment, long offSet)
        {
            ...
            // Envia novo evento
            string topicProducer = _kafkaSettings?.Producer?.Topic ?? string.Empty;
            var responseMessage = new RecorrenciaIncluidaMessage(dadosSolicitacao);
