...
public class QRCodeTools
{
    ...
    private string CPR = @"00020126180014(.{1,14})5204(.{4})5303(.{3})5802(.{2})5913(.{1,13})6008(.{1,8})62070503\*\*\*80740014(.{1,14})2552(.{1,52})00026304F2DA";

    //QR Code composto com dados dinâmicos (pagamento imediato ou com vencimento) e parâmetros de recorrência
    private string CDPR = @"00020101021226700014(.{1,14})2548(.{1,48})5204(.{4})5303(.{3})5802(.{2})5913(.{1,13})6008(.{1,8})62070503\*\*\*80740014(.{1,14})2552(.{1,52})00026304FB42";

    //QR Code composto com dados estáticos e parâmetros de recorrência:
    private string CEPR = @"00020126580014(.{1,14})0136(.{1,48})5204(.{4})5303(.{3})5406(.{1,6})5802(.{2})5913(.{1,13})6008(.{1,8})62070503\*\*\*80740014(.{1,14})2552(.{1,52})000263042875";
