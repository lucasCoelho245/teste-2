namespace Pay.Recorrencia.Gestao.Domain.Entities
{
    ...
    public class ContaDict
    {
        ...
        public object IdRequisicao { get; set; }
        ...
        public object OwnerStatistics { get; set; }
        ...
        public object IdCID { get; set; }
        public object KeyStatistics { get; set; }
    ...
    public class PayloadQRCode
    {
        ...
        public object IdRevisaoPayload { get; set; }
        ...
        public object PrestadorServicoTroco { get; set; }
        public object PrestadorServicoSaque { get; set; }
        public string ObjetoVinculo { get; set; }
        public string IdTransacao { get; set; }
        public string DsStatus { get; set; }
    }
    public class TraducaoQRCodeRecorrencia
    {
        public string AccessToken { get; set; }
        public string IdTransacao { get; set; }
        ...
        public string NrSpbRecebedor { get; set; }
        public string NrAgenciaRecebedor { get; set; }
        public string PContaRecebedor { get; set; }
        public string NrContaRecebedor { get; set; }
        public string TpPessoaRecebedor { get; set; }
        public string NrCpfCnpjPessoaRecebedor { get; set; }
        public string NmPessoaRecebedor { get; set; }
    ...
    public class EventoInclusaoAutorizacaoRecorrencia
    {
        public string IdRecorrencia { get; set; }
        public string TipoRecorrencia { get; set; } = "RCUR";
    ...
    public class EventoAtualizarControleJornada
    {
